<div class="main-content">
    ...
    <div class="block justify-between page-header md:flex">
        <div>
            <h3 class="text-gray-900 hover:text-gray-900 dark:text-white dark:hover:text-white text-2xl font-medium">Dashboard</h3>
        </div>
                ...
                <div class="box-body">
                    <div class="flex space-x-4 rtl:space-x-reverse">
                        ...
                        <div class="">
                            ...
                            <div>
                                <span class="text-xs mb-0">Increased by <span class="text-success">+2.5%</span></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-body">
                    <div class="flex space-x-4 rtl:space-x-reverse">
                        ...
                        <div class="">
                            ...
                            <div>
                                <span class="text-xs mb-0">Increased by <span class="text-success">+2.58%</span></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-body">
                    <div class="flex space-x-4 rtl:space-x-reverse">
                        ...
                        <div class="">
                            ...
                            <div>
                                <span class="text-xs mb-0">Decreased by <span class="text-danger">-14.9%</span>
                                </span>
                            </div>
                        </div>
                    </div>
